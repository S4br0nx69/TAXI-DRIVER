...
def user_mode():
    ...
    gamma = float(input("Discount factor γ [0.99] : ") or 0.99)
    ...
    agent = Agent.DQNAgent('rgb_array')
    agent.lr = lr
    agent.gamma = gamma
...
def time_limited_mode():
    ...
    print(f"\nParamètres optimisés : lr={agent.lr}, γ={agent.gamma}, "
...
if __name__ == "__main__":
    print("╔══════════════════════════════════════════╗")
    print("║    TAXI DRIVER — Deep Q-Learning (DQN)   ║")
    print("╚══════════════════════════════════════════╝")

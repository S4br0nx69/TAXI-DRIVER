...
def user_mode():
    ...
    alpha = float(input("Learning rate α [0.1] : ") or 0.1)
    gamma = float(input("Discount factor γ [0.6] : ") or 0.6)
    ...
    taxi.epsilon_min = epsilon_min
    taxi.epsilon_decay = epsilon_decay
